...
def create_bd():
    ...
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Emely S.','True','This deadly spiral','0')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Theodor D.','False','American tragedy','0')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('George Martin','True','Game of Thrones','0')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Michael Talbot','True','The horrors of the night','0')")

    cursor.execute("INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('King S.','True','Radiance','1')")
    cursor.execute("INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Kodzi S.','False','The bell','1')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Wonston C.','True','Before i fall asleep','1')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Barker K.','True','Hellraiser','1')")

    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Jojo Moyes','True','After you','2')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('John Boyne','True','The Boy in the Striped Pajamas','2')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Erich Maria','True','Life on loan','2')")

    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Yunas Yunasson','True','One hundred years and a suitcase of money in addition','3')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Anne Fine','True','The Killer Cat Diary','3')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Vladimir Voinovich','True','Raspberry pelican','3')")

    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Dennis Lehane','True','Isle of the Damned','4')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Ian Banks','False','Aspen Factory','4')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Boileau Narsezhak','True','She-wolves','4')")

    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Ulya Laska','True','Give me two!','5')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Oksana Alekseeva','False','Dial my number at night','5')")
    cursor.execute(
        "INSERT INTO data_book (author, rate, nameofbook, genre) VALUES ('Reed michelle', 'True', 'Her friends groom','5')")
    return cursor


def get_books(a, cursor):
    sql = "SELECT nameofbook FROM data_book WHERE genre=?"
